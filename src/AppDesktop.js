...
class AppDesktop extends React.Component {
  render() {
    return <LandingDesktop {...LandingDesktopData} />;
  }
}
  ...
  render() {
    ...
    return (
      <div className="macbook-3">
        ...
        <p className="text-2 roboto-bold-mine-shaft-16px">{text2}</p>
        <div className="text-3 roboto-bold-mine-shaft-16px">{text3}</div>
        <div className="text-4 roboto-bold-mine-shaft-16px">{text4}</div>
        <div className="text-5 roboto-bold-mine-shaft-16px">{text5}</div>
        <p className="text-6 roboto-normal-mine-shaft-16px-2">
          <span className="span1">{spanText}</span>
          <a href="#" className="span2">{spanText2}</a>
        </p>
        <p className="text-7 roboto-normal-mine-shaft-16px">{text7}</p>
        <p className="text-8 roboto-normal-mine-shaft-16px">{text8}</p>
        <a href="https://oips.overlay.market/" className="oip roboto-normal-mine-shaft-16px">{oip}</a>
        <a href="https://github.com/overlay-market/" className="github roboto-normal-mine-shaft-16px">{github}</a>
        ...
        <div className="overlap-group1">
          <ButtonPrimary launchApp={buttonPrimaryProps.launchApp} />
  ...
  render() {
    ...
    return (
      <div className="button-primary">
        <a href="https://overlay.exchange/" target="_blank" className="launch-app roboto-normal-mine-shaft-16px">{launchApp}</a>
      </div>
    );
  }
}
